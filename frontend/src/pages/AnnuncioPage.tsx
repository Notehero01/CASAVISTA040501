...
export function AnnuncioPage({ currentUser, onStartChat }: AnnuncioPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {isLightboxOpen && (
        <div
          className="fixed inset-0 z-[1000] flex flex-col bg-black/95 text-white [padding-bottom:env(safe-area-inset-bottom)] [padding-top:env(safe-area-inset-top)]"
          role="dialog"
          aria-modal="true"
          onClick={(event) => {
        ...
        >
          <div className="z-20 flex shrink-0 items-center justify-between gap-3 px-3 py-3 sm:px-5 sm:py-4">
            ...
            <button
              ...
              className="inline-flex h-11 shrink-0 items-center gap-2 rounded-full bg-white/12 px-3 text-sm font-semibold text-white transition-colors hover:bg-white/22 sm:px-4"
